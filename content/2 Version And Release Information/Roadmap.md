...
2. Hot daily refresh: when data has been refreshed, e.g. after a daily warehouse load, the in memory network should refresh without down-time;
...
5. [[../3 Overview/Networks/Derived Commodity|Derived Commodity]].
