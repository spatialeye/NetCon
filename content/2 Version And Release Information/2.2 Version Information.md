...
* New trace modes `UpInBarring` & `DownInclBarring` have been introduced when using flow (upstream & downstream): use flow and include barring barriers (those do not have flow, but are handy to retrieve).
