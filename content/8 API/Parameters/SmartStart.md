...
In earlier versions the Start connections would be exempted from the Yield as well.
This is no longer the case, which means a Yield can also result in a start element being returned.
This will affect the [[../Calls/TracePath|TracePath]] call, which stops after finding the first path.
