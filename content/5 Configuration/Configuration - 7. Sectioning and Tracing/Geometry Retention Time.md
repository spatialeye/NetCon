...
This is set in [[./NetConTrace feature source|NetConTrace feature source]].
...
Because the output of the [[../../8 API/NetCon API Calls|NetCon API Calls]] are typically in GeoJSon, which does not support curves, geometries in the cache are faceted.
