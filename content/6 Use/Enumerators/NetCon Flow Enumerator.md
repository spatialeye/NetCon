...
|        3 | Meshed    | Both the FromId and ToId are fed from a source, so the flow can be both ways. A network in which there is redundancy and consumers are fed via different routes, is a meshed network. `` |
