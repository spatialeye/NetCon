...
How commodities can transfer or *connect* to other commodities can be specified in [[../../5 Configuration/Commodities/Commodity Rules|Commodity Rules]]. If no rules are set, all is allowed, as far as restricted by the registration system of course.
...
|       E | LV;PL                | low voltage and public lighting as secondary commodity, used in so called combi-cables.                              |
|       E | LV::ABCN;PL          | low voltage with three phase and neutral and public lighting as secondary commodity, used in so called combi-cables. |
|       G |                      | **Gas network**                                                                                                      |
