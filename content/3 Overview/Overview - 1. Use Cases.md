...
| History I               | yes         | Fault analysis on historized networks (time travel and scenarios). Risk-based asset management.                                                                                                                                                                                                                             |
| History II              | planned     | Detailed smart grid fault analysis after huge blackout by automated switching systems.                                                                                                                                                                                                                                      |
...
| Prediction              | research    | Aggregating smart meter & IoT data to build predictive models for production / consumption loads using ML/AI. Aggregating to DSO/TSO usage.                                                                                                                                                                                |
...
| Energy theft            | planned     | Combine endpoint and midpoint calculations to detect losses.                                                                                                                                                                                                                                                                |
| Network Dynamics        | planned     | Determining network capacity, safety, quality on the fly or periodically for parts of the network. Scenario / capacity planning.                                                                                                                                                                                            |
